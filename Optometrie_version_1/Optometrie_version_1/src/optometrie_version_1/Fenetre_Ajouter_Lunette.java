 ...
 * @author Milano
 */
public class Fenetre_Ajouter_Lunette extends Stage{
 
    private AnchorPane grand_conteneur = new AnchorPane();
    private Scene scene3 = new Scene(grand_conteneur,930, 546);
    ...
    public Fenetre_Ajouter_Lunette()
    {
       
     initialiser_fenetre();
      evenement_gestion();
    this.setResizable(false);
    this.setTitle("Ajout Lunetterie");  
   ...
   public void ajouter_lunette_fonction(){
       
       
   String ajouter_requete="INSERT INTO `lunette` ( `Nom`, `Prenom`, `Age`, `Adresse`, `Montant`, `MedecinTraitant`, `Date`, `VLDs`, `VLDc`, `VLDa`, `VLGs`, `VLGc`, `VLGa`, `VPDs`, `VPDc`, `VPDa`, `VPGs`, `VPGc`, `VPGa`, `TypeVerre`, `Teinte`, `Montant_restant`, `telphone`)  VALUES ('"+nom_field.getText().trim()+"','"+prenom_field.getText().trim()+"','"+age_field.getText().trim()+"','"+adresse_field.getText().trim()+"',";
       ...
       ajouter_requete+=type_verre_field.getText().trim()+"','"+teinte_field.getText().trim()+"',";
       ...
       ajouter_requete+=telephone_field.getText().trim()+"')";
   ...
   public void vider_champs(){
               ...
               VPGc_field.setText("");
               VPGa_field.setText("");               
               type_verre_field.setText("");
               teinte_field.setText("");
